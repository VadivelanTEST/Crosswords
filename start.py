...
def format_to_html(crossword_data, date):
    html = f"""
        <header>
            <h1 itemprop="headline">XWordHint Times Crossword Complete Solution: {date.strftime('%B %d, %Y')}</h1>
                ...
                <div class="clue-item" itemscope itemtype="https://schema.org/Question">
                    ...
                    <div class="clue-meta">
                        ...
                        <span class="answer" itemscope itemtype="https://schema.org/Answer">
                            Answer: <a itemprop="text" href="/search?q={answer.lower().replace(' ', '-')}/">{answer}</a>
                        </span>
                    </div>"""
